...
public class foodSelectDinner extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_select_dinner);

        Toast.makeText(getApplicationContext(), "저녁 식사 정보", Toast.LENGTH_SHORT).show();

        intent=getIntent();
        arrayFoodList=(ArrayList<food>)intent.getSerializableExtra("Foodname");
        Serializable s=intent.getSerializableExtra("Foodname");

        toal_kcal=(TextView)findViewById(R.id.tv_total_kcal_dinner);
        ...
        //리사이클러뷰 초기화
        mRecyclerView = findViewById(R.id.recyclerView_dinner);// 리사이클러뷰 레이아웃 연결
