...
public class Board_noticeActivity extends AppCompatActivity {
    ...
    private FirebaseDatabase sDatabase; //데이터베이스
    private DatabaseReference sReference;
    private ChildEventListener sChild;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        search.setOnClickListener(new View.OnClickListener() { //검색버튼
            @Override
    ...
    private void initDatabase2() { //데이터베이스 초기화
        sDatabase = FirebaseDatabase.getInstance();

        sReference = sDatabase.getReference("Board");

        sChild = new ChildEventListener() {
        ...
        sReference.addChildEventListener(sChild);
    }
    @Override
    protected void onDestroy() {
        super.onDestroy();
        bReference.removeEventListener(bChild);
        sReference.removeEventListener(sChild);
    }
