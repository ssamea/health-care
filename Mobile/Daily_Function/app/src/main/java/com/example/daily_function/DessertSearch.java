...
public class DessertSearch extends AppCompatActivity {
    ...
    static final String TAG="Search_Activity_Dessert";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dessert_search);

        Toast.makeText(getApplicationContext(), "간식 입력", Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.toolbar_next_button:  // 오른쪽 상단 버튼 눌렀을 때
                ...
                Intent intent = new Intent(this, foodSelectDessert.class);
