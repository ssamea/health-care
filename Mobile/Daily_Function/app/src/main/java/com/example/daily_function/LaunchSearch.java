...
public class LaunchSearch extends AppCompatActivity {
    ...
    static final String TAG="Search_Activity_Launch";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(getApplicationContext(), "점심식사 입력", Toast.LENGTH_SHORT).show();
        // firestor 객체 얻어오기
        db = FirebaseFirestore.getInstance();
        docRef = db.collection("foodinfo").document("0e6383e0-533f-11eb-b41e-1377c1a09322");

        //위젯 연결
        ed_search = (EditText) findViewById(R.id.foodName_launch);
        btn = (Button) findViewById(R.id.button_search_launch);
        //str_search=ed_search.getText().toString();// 에디트텍스트 스트링값으로 변환

        //리사이클러뷰 초기화
        mRecyclerView = findViewById(R.id.recyclerView_launch_1);// 리사이클러뷰 레이아웃 연결
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.toolbar_next_button:  // 오른쪽 상단 버튼 눌렀을 때
                ...
                Intent intent = new Intent(this, foodSelectLaunch.class);
